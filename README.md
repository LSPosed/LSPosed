...
A Zygisk module trying to provide an ART hooking framework which delivers consistent APIs with the OG Xposed, leveraging YAHFA hooking framework.
...
- [LSPlant](https://github.com/LSPosed/LSPlant): Android ART hook library
